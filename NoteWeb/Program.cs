...
using NoteWeb.Logic.Configurations;
...
builder.Services.AddDbContextPool<NoteWebContext>(opt => opt.UseLazyLoadingProxies().UseMySql(connString, ServerVersion.AutoDetect(connString), builder => builder.MigrationsAssembly("NoteWeb")));
