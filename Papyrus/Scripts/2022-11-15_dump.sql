...
VALUES ('20220904130327_Init', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220909193502_RemoveCloseRight', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220912185943_RemoveNoteCreatRight', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220915072726_NoteArchiveStatus', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220921201423_AddThemeStore', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221007123816_AddPosts', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221007172339_AddPostTableRename', '6.0.10');
...
ALTER TABLE `Notes` ADD `FolderId` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '';

CREATE TABLE `Folders` (
    `Id` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `ParentId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    ...
    CONSTRAINT `CK_Folder_Owner` CHECK ((GroupId IS NOT NULL OR UserId IS NOT NULL) AND NOT (GroupId IS NOT NULL AND UserId IS NOT NULL)),
    CONSTRAINT `FK_Folders_AspNetUsers_CreatorId` FOREIGN KEY (`CreatorId`) REFERENCES `AspNetUsers` (`Id`) ON DELETE SET NULL,
    ...
    CONSTRAINT `FK_Folders_Groups_GroupId` FOREIGN KEY (`GroupId`) REFERENCES `Groups` (`Id`) ON DELETE CASCADE
) CHARACTER SET=utf8mb4;

CREATE INDEX `IX_Notes_FolderId` ON `Notes` (`FolderId`);

CREATE INDEX `IX_Folders_CreatorId` ON `Folders` (`CreatorId`);

CREATE INDEX `IX_Folders_GroupId` ON `Folders` (`GroupId`);

CREATE INDEX `IX_Folders_ParentId` ON `Folders` (`ParentId`);

CREATE INDEX `IX_Folders_UserId` ON `Folders` (`UserId`);

ALTER TABLE `Notes` ADD CONSTRAINT `FK_Notes_Folders_FolderId` FOREIGN KEY (`FolderId`) REFERENCES `Folders` (`Id`) ON DELETE CASCADE;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221011200523_AddFolders', '6.0.10');

COMMIT;

START TRANSACTION;

ALTER TABLE `Folders` MODIFY COLUMN `ParentId` varchar(255) CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221011205352_AddNullableFolderParent', '6.0.10');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221013184105_FolderName', '6.0.10');
...
ALTER TABLE `Notes` MODIFY COLUMN `Title` varchar(40) CHARACTER SET utf8mb4 NOT NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221015123538_NoteDeleteStatusRemove', '6.0.10');

COMMIT;

START TRANSACTION;

CREATE TABLE `AppAccesses` (
    `Id` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `UserId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `Timestamp` datetime(6) NOT NULL,
    CONSTRAINT `PK_AppAccesses` PRIMARY KEY (`Id`),
    CONSTRAINT `FK_AppAccesses_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `AspNetUsers` (`Id`) ON DELETE CASCADE
) CHARACTER SET=utf8mb4;

CREATE INDEX `IX_AppAccesses_UserId` ON `AppAccesses` (`UserId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221022175213_AppAccessTable', '6.0.10');
...
CREATE TABLE `NoteAccesses` (
    ...
    `NoteId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `Timestamp` datetime(6) NOT NULL,
    CONSTRAINT `PK_NoteAccesses` PRIMARY KEY (`Id`),
    CONSTRAINT `FK_NoteAccesses_AspNetUsers_UserId` FOREIGN KEY (`UserId`) REFERENCES `AspNetUsers` (`Id`) ON DELETE CASCADE,
    CONSTRAINT `FK_NoteAccesses_Notes_NoteId` FOREIGN KEY (`NoteId`) REFERENCES `Notes` (`Id`) ON DELETE CASCADE
) CHARACTER SET=utf8mb4;

CREATE INDEX `IX_NoteAccesses_NoteId` ON `NoteAccesses` (`NoteId`);

CREATE INDEX `IX_NoteAccesses_UserId` ON `NoteAccesses` (`UserId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221022181936_NoteAccessTable', '6.0.10');
...
INSERT INTO `Translations` (`Key`, `Language`, `Segment`, `Value`)
VALUES ('Remove', 'en-US', 'Group', 'Group is removed');

INSERT INTO `Translations` (`Key`, `Language`, `Segment`, `Value`)
VALUES ('Remove', 'hu-HU', 'Group', 'Csoport törölve');

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221030194124_GroupRemoveLog', '6.0.10');

COMMIT;

START TRANSACTION;

ALTER TABLE `GroupRoles` DROP KEY `AK_GroupRoles_GroupId_Name`;

ALTER TABLE `GroupRoles` MODIFY COLUMN `Name` varchar(40) CHARACTER SET utf8mb4 NOT NULL;

CREATE INDEX `IX_GroupRoles_GroupId` ON `GroupRoles` (`GroupId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221030200942_GroupRoleKeyChange', '6.0.10');
...
CREATE TABLE `Applications` (
    ...
    `Description` longtext CHARACTER SET utf8mb4 NULL,
    `UserId` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `PublicId` longtext CHARACTER SET utf8mb4 NOT NULL,
    `SecretId` longtext CHARACTER SET utf8mb4 NOT NULL,
    `Creation` datetime(6) NOT NULL,
    `LastUpdate` datetime(6) NOT NULL,
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221105143926_Applications', '6.0.10');
